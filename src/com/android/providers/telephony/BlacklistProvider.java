...
public class BlacklistProvider extends ContentProvider {
    ...
    private ContentValues validateAndPrepareContentValues(
        ...
        if (values.containsKey(Blacklist.NUMBER)) {
            ...
            String nonStringstrictNormalizedNumber = normalizeNumber(getContext(), number, false);
            boolean isRegex = BlacklistUtils.isBlacklistRegexEnabled(getContext()) &&
                    (nonStringstrictNormalizedNumber.indexOf('%') >= 0
                    || nonStringstrictNormalizedNumber.indexOf('_') >= 0);
            ...
            final String normalizedNumber = isRegex ?
                    nonStringstrictNormalizedNumber : strictNormalizedNumber;
