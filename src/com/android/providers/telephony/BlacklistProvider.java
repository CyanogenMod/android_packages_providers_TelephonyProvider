...
public class BlacklistProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case BL_ID:
                ...
                break;
            case BL_NUMBER: {
                String number = normalizeNumber(uri.getLastPathSegment(), false);
    ...
    public Uri insert(Uri uri, ContentValues initialValues) {
        ...
        values.put(COLUMN_NORMALIZED, normalizeNumber(number, true));
        ...
        switch (match) {
            ...
            case BL_NUMBER:
                count = db.delete(BLACKLIST_TABLE, COLUMN_NORMALIZED + " = ?",
                        new String[] { normalizeNumber(uri.getLastPathSegment(), false) });
                break;
            default:
    ...
    // not converting characters and support for regex
    private String normalizeNumber(String number, boolean regex) {
