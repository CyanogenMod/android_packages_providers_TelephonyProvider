...
public class BlacklistProvider extends ContentProvider {
    ...
    private SharedPreferences mTimestampSharedPrefs;
    ...
    public boolean onCreate() {
        ...
        mTimestampSharedPrefs = getContext()
    ...
    private long updateTimestamp() {
        ...
        SharedPreferences.Editor editor = mTimestampSharedPrefs.edit();
    ...
    private long getTimestamp() {
        long timestamp = mTimestampSharedPrefs.getLong(BLACKLIST_TIMESTAMP, 0);
        if (DEBUG) {
    ...
    public String getType(Uri uri) {
        switch (sURIMatcher.match(uri)) {
            ...
            case BL_TIMESTAMP:
                return "vnd.cyanogenmod.cursor/timestamp";
            default:
