...
public class TelephonyProvider extends ContentProvider
{
    ...
    private static final int URL_PREFERAPN_NO_UPDATE_USING_SUBID_IMSI = 15;
    ...
    static {
        ...
        s_urlMatcher.addURI("telephony", "carriers/preferapn_no_update/subIdImsi/*",
                URL_PREFERAPN_NO_UPDATE_USING_SUBID_IMSI);
    ...
    private long getPreferredApnId(int subId, String imsi, boolean checkApnSp) {
        ...
        if (apnId == INVALID_APN_ID && checkApnSp) {
            apnId = getPreferredApnIdFromApn(subId);
            if (apnId != INVALID_APN_ID) {
                setPreferredApnId(apnId, subId, imsi);
                deletePreferredApn(subId);
            }
        }
        return apnId;
    ...
    public synchronized Cursor query(Uri url, String[] projectionIn, String selection,
        ...
        switch (match) {
            ...
            case URL_PREFERAPN_NO_UPDATE_USING_SUBID_IMSI:
