...
public class SmsProvider extends ContentProvider {
    ...
    public Cursor query(Uri url, String[] projectionIn, String selection,
        ...
        switch (match) {
            ...
            case SMS_ALL_ICC:
                return getAllMessagesFromIcc(INVALID_SUBSCRIPTION);

            case SMS_ICC:
                String messageIndexIcc = url.getPathSegments().get(MESSAGE_ID);

                return getSingleMessageFromIcc(messageIndexIcc, INVALID_SUBSCRIPTION);
            ...
            case SMS_ICC1:
                ...
                return getSingleMessageFromIcc(messageIndexIcc1, SUB1);
            ...
            case SMS_ICC2:
                ...
                return getSingleMessageFromIcc(messageIndexIcc2, SUB2);
    ...
    public int delete(Uri url, String where, String[] whereArgs) {
        ...
        switch (match) {
            ...
            case SMS_ICC:
                ...
                return deleteMessageFromIcc(messageIndexIcc, INVALID_SUBSCRIPTION);
            case SMS_ICC1:
                String messageIndexIcc1 = url.getPathSegments().get(MESSAGE_ID);

                return deleteMessageFromIcc(messageIndexIcc1, SUB1);
            case SMS_ICC2:
                String messageIndexIcc2 = url.getPathSegments().get(MESSAGE_ID);

                return deleteMessageFromIcc(messageIndexIcc2, SUB2);
